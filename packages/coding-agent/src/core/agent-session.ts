...
export class AgentSession {
	...
	getQuotaParkState(): { isParked: boolean; resumeAtMs: number; parkCount: number } | undefined {
		if (!this._quotaPark) return undefined;
		return {
			isParked: true,
			resumeAtMs: this._quotaPark.resumeAtMs,
			parkCount: this._quotaPark.parkCount,
		};
	}
